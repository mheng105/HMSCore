        ...
        mDb.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.getValue()==null){
                    ...
                    acc.mail=edtMail.getText().toString();
                    acc.user=edtUser.getText().toString();
                    acc.pass=edtPaswd.getText().toString();
                    acc.confirm=edtConfirm.getText().toString();
                    mDb.setValue(acc,new DatabaseReference.CompletionListener(){
                        ...
                        public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                            if(error==null){
                                ...
                                i.putExtras(b);
                                startActivity(i);
                            }else Toast.makeText(SignUp.this,"Sign Up fail",Toast.LENGTH_SHORT).show();
                        }
                    });
                }else Toast.makeText(SignUp.this,"Account already exists",Toast.LENGTH_SHORT).show();
            }
